...
public class waveOne
{
    ...
    private Rectangle beeRect;
    private Image bee, explosion;
    ...
    public waveOne(int xDimension, int yDimension)
    {        
        try {
        ...
        width = 50;
        height = width;
        x = xDimension*width+125;
        y = yDimension*height+300;
        originalXPos = xDimension*width+125;
        originalYPos = yDimension*height+300;
        Vel = -1;
        yVel = 0;

        bee = Toolkit.getDefaultToolkit().getImage(getClass().getResource("waveOne.gif"));
        bee = bee.getScaledInstance(50, 50, 1);
        ...
        beeRect = new Rectangle (x, y, width, height);
